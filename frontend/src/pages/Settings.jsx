import { Send, ArrowBigLeftDash } from "lucide-react";
...
const PREVIEW_MESSAGE = [
  { id: 1, content: "Let's go and have some ichiraku ramen !", isSent: false },
  { id: 2, content: "Sure ! When shall we go ?", isSent: true },
];
  ...
  return (
    <div className="min-h-screen container mx-auto px-4 pt-20 max-w-5xl ">
      ...
      <div className="relative">
        ...
        <div className="absolute top-0 right-0  w-[60px]">
                ...
                <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                  ...
                  <div className="px-4 py-3 border-b border-base-300  bg-base-100">
                    <div className="flex items-center gap-3 ">
                      ...
                      <div>
                        <h3 className="font-medium text-sm ">Naruto</h3>
                  ...
                  <div className="p-4 space-y-4 min-h-[200px] max-h-[200px] overflow-y-auto bg-base-100">
                    {PREVIEW_MESSAGE.map((messages) => (
                      <div key={messages.id} className={`flex ${messages.isSent ? "justify-end" : "justify-start"}`}>
                        <div className={`max-w-[80%] rounded-xl p-3 shadow-sm ${messages.isSent ? "bg-primary text-primary-content" : "bg-base-200"}`}>
                  ...
                  <div className="p-4 border-t border-base-300 bg-base-100 ">
                    <div className="flex gap-2 ">
                      <input
                        ...
                        spellCheck={false}
                      />
                      <button className="btn btn-primary h-10 min-h-0 " onClick={() => setMsg("")}>
                        <Send size={18} />
                      </button>
                    </div>
                  </div>
